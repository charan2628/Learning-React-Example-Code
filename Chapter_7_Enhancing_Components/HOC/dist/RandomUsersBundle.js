...
/******/ 	return __webpack_require__(__webpack_require__.s = "./RandomUsers.js");
/******/ })
/************************************************************************/
/******/ ({
...
var DataComponet = function DataComponet(ComposedeComponet, url) {
  return (
    /*#__PURE__*/
    function (_Component) {
      _inherits(DataComponet, _Component);

      function DataComponet(props) {
        var _this;

        _classCallCheck(this, DataComponet);

        _this = _possibleConstructorReturn(this, _getPrototypeOf(DataComponet).call(this, props));
        _this.state = {
          data: [],
          loading: false,
          loaded: false
      ...
      _createClass(DataComponet, [{
        ...
        value: function componentWillMount() {
          ...
          isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()(url).then(function (response) {
        ...
        value: function render() {
          ...
          }, this.state.loading ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Loading...") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ComposedeComponet, this.state));
        }
      }]);
...
/* harmony default export */ __webpack_exports__["default"] = (DataComponet);
...
var PeopleList = function PeopleList(_ref) {
  ...
  }, data.results.map(function (person, i) {
...
/* harmony import */ var _PeopleList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PeopleList */ "./PeopleList.js");
/* harmony import */ var _DataComponent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DataComponent */ "./DataComponent.js");
...
var RandomUsers = Object(_DataComponent__WEBPACK_IMPORTED_MODULE_3__["default"])(_PeopleList__WEBPACK_IMPORTED_MODULE_2__["default"], "https://randomuser.me/api/?results=");
render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(RandomUsers, {
  count: 10
...
/******/ });
//# sourceMappingURL=RandomUsersBundle.map